...
function MoviesCard() {
	return (
		<div className="movies-card">
			<img className="movies-card__image" src="https://thecity.m24.ru/b/d/SYketSiveYs9JffObLLBFlFNGhtudTX-kYVfOS8Xp1Gj5pqKzWTJSFS-PsArI08gRZaK1yZktQXWesHOaOz7FWcJ5xZMng=xC4cpbRD2LUqTSWmL6Ve8w.jpg" alt="33 слова о дизайне" />
